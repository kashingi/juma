			...
			<header class="jumbotron text-center row" style="margin-bottom:2px; background:linear-gradient(white, #0073e6); padding:10px;">
				...
				<div class="col-sm-2">
					<nav class="btn-group-vertical btn-group-sm" role="group" aria-label="button-group">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="location.href = 'edit-account.php'">Your Account</button>
				...
				<div class="col-sm-8 text-center">
                    ...
                    <P>
                        ...
                        try {
                            ...
                            $query = "SELECT CONCAT(Lastname, '    ', Firstname) AS name, Course, ";
                            ...
                            if ($result) { // If it ran OK, display the records.
                                ...
                                <tr><th scope="col">Name</th><th scope="col">Course</th><th scope="col">Date Registered</th></tr>';
                                // Fetch and print all the records:	#3
                                while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) 
                                { 
                                    echo '<tr><td>' . $row['name'] . '</td><td>' . $row['Course'] . '</td><td>'. $row['regdat'] . '</td></tr>'; 
                               }
