				...
				<div class="col-sm-8">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        try
                            ...
                            $query = "SELECT Userid, Lastname, Firstname, Address, City, Course, County, Zip_code,";
                            $query .= " Phone FROM users WHERE Lastname=? AND Firstname=?";
                            ...
                            if ($result) { // If it ran, display the records.
                                ...
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    ...
                                    // #2
                                    echo '<tr>
                                            <td scope="row"><a href="edit-address.php?id=' . $Userid .
                                            '">Edit</a></td>
